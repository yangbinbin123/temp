	...
	protected void onHandleIntent(Intent intent) {
		...
		if(!wifiInfo.isGroupOwner)
		{
			...
			try {
				...
				clientSocket.connect(new InetSocketAddress(targetIP,port),10*1000);
			    ...
			    while(true)
			    {
					...
					//float result = 8*1000*1000/interval;
					//System.out.println("Speed:"+result+"MBPS");         //Calsulate the speed for transfering file
